    ...
    <div class="container-Home">
        ...
        <div class="categories">
            <div class="page ">
                ...
                <button class="explore-btn "><a href="index.php?controller=product&action=fashion">Explore now</a></button>
            </div>
            <div class="page">
                <p>Cuisine</p>
                <div class="slider">
                ...
                <button class="explore-btn "><a href="index.php?controller=product&action=food">Explore now</a></button>
            </div>
            <div class="page">
                <p>Other Products</p>
                <div class="slider ">
                ...
                <button class="explore-btn "><a href="index.php?controller=product&action=another">Explore now</a></button>
            </div>
        </div>
        <div class="introduce">
            <div class="vk ">
