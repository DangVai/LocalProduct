    ...
    <div class="container">
        ...
        <div class="product-list">
            <?php if (!empty($products)): ?>
                ...
                <?php endforeach; ?>
            <?php else : ?>
                <p>Bạn chưa thêm sản phẩm nào vào mục yêu thích! <br> Khám phá ngay các sản phẩm khác! <a href="index.php?controller=cart&action=addToCart" class="cart-home">Khám phá ngay các sản phẩm khác!</a></p>
            <?php endif; ?>
        </div>
    </div>
