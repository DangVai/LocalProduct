...
<body>
    <div class="container-Home">
        <?php include 'Views/frontend/headerer.php'; ?>
        <div class="header">
            <!-- Logo -->
            <div class="box_logo">
            ...
            <div class="name-user">
                ...
                <div class="dropdown-menu" id="account-menu">
                    ...
                    <div>
                        <a href="#"><i class="fas fa-sign-in-alt fa-sm fa-fw mr-2 text-gray-400"></i> Log in</a>
                    </div>
                    <div>
                        <a href="#"><i class="fas fa-sign-out-alt fa-sm fa-fw mr-2 text-gray-400"></i> Log out</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <?php include 'Views/frontend/footer.php'; ?> <!-- Nhúng Footer -->
    </div>
    <script>
