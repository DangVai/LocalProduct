    ...
    <div class="img-sliders ">
        ...
        <div class="slider-container ">
            <div class="slides " id="slider3 ">
                <img src="/LocalProduct/public/images/Chị Huyền.jpg " class="slide " alt="Slide 1 ">
                <img src="/LocalProduct/public/images/ảnh 5.jpg " class="slide " alt="Slide 2 ">
                <img src="/LocalProduct/public/images/det.jpg " class="slide " alt="Slide 3 ">
            </div>
        </div>
    </div>
    </div>
