...
class CartController extends BaseController
{
    ...
    public function addToFavorite()
    {
        ...
        if (!$userId) {
            echo json_encodeAV(['success' => false, 'message' => 'You must log in to add products to the cart.']);
            return;
        }
    ...
    public function viewFavorite()
    {
        ...
        $favorite = $this->productModel->getCartItems($userId);

        // Hien thi giao dien cart.php
        $this->viewWithoutLayout('frontend.products.favorite', ['favorite' => $favorite]);
    }
